...
},{"../modules/ajaxcodecall":4,"../modules/animate":5,"../modules/dialogUi":6,"../modules/form":9,"../modules/template":12,"../plugins/autocomplete":18,"../plugins/datepic":19}],11:[function(require,module,exports){
/*
* 事件统计
* 依赖百度统计
* worker liujinqiang
...
},{"../modules/ajaxcodecall":4,"../modules/animate":5,"../modules/dialogUi":6,"../plugins/select":20}],14:[function(require,module,exports){
...
var
    ...
    floatlayer = require('../modules/floatlayer');
// $("body").on('click','[role-click=tipmobile]',function(){
// 	_Fn.alert("请先绑定手机号");
// })



},{"../modules/dialogUi":6,"../modules/floatlayer":7,"../modules/invests":10,"../modules/template":12,"./app":16}],18:[function(require,module,exports){
    ...
    function dataToDom(data) {
        ...
        for (var i=0; i < num; i++) {
            ...
            if (options.formatItem) {
                ...
                var rowval = row[0];
                rowval = rowval.split(':')[0];

                li.innerHTML = rowval;
                li.selectValue = rowval;
            }
            var extra = null;
            if (row.length > 1) {
                extra = [];
