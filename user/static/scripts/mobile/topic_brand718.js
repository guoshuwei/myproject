var
    ...
    tagTime = 1500480000,//2017-07-20 00:00:00;
    startTime = 1500220800;//2017-07-17 00:00:00;
...
lazyload.bind($('.fn-lazyload-addrate'),function(){

    _Fn.loading().show(addrateBox);
    $.ajax({
        url: _Fn.mockServer + '/topic/hotplatform',
        type: 'post',
        dataType: 'json',
        success: function(res){
            _Fn.loading().hide();
            if(res.code == 200){
                var content = template.render('platformTpl',{data:res.data});
                addrateBox.html(content);
                new Swiper ('.swiper-container1', {
                    direction: 'horizontal',
                    loop: true,
                    pagination: '.ui-addrate-pager',
