...
.dataTables_empty{text-align:center;margin-top:150px;} 
    a:hover{color:red;}
</style>
    ...
    <div class="index_body">
        <div class="index_page">
            <div class="page_cont">
                ...
                <div class="bd page_introduce smt" style="font-size:12px;">
                    <?php if(is_array($re_leftsublist)): foreach($re_leftsublist as $k=>$re_leftsublist): if((isset($_GET['sid']) AND ($k == $_GET['sid']))): ?><ul class="item active">
                                <?php if(count($re_leftsublist['sub']['title']) == 1): if(is_array($re_leftsublist["sub"]["content"])): foreach($re_leftsublist["sub"]["content"] as $k=>$content): ?><li style="">
                                ...
                                <?php else: ?>
                                    <?php if(is_array($re_leftsublist["sub"]["title"])): foreach($re_leftsublist["sub"]["title"] as $k=>$title): ?><li style="height:32px;color:#818181">
                                            <a href="<?php echo U('Sublist/show_content','id='.$re_leftsublist['sub']['id'][$k]);?>">
                                                <span clas="title"><?php echo ($title); ?></span>
                                                <span class="uptime"><?php echo date('Y-m-d',$re_leftsublist['sub']['dt'][$k]);?></span>
                                            </a>
...
<script>
 $(function(){
		...
		$('.dataTables_empty').closest('.dataTables_wrapper').css('marginTop','150px')
    });
