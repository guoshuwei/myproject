        ...
        <div class="index_page">
            <div class="page_cont">
                ...
                <div class="bd page_introduce" style="font-size:12px;">
                    <?php if(is_array($re_leftsublist)): foreach($re_leftsublist as $key=>$re_leftsublist): if($re_leftsublist["index"] == 0): if(count($re_leftsublist['sub']['title']) > 15): ?><table class="table-sort" style="width:100%;margin-top: -5px;">
                                    <thead>
                                        <tr class="text-c">
                                            <td></td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php if(is_array($re_leftsublist["sub"]["title"])): foreach($re_leftsublist["sub"]["title"] as $k=>$title): ?><tr><td style="height:32px;color:#818181">
                                                    <a href="<?php echo U('Sublist/show_content','id='.$re_leftsublist['sub']['id'][$k]);?>" style="width:100%;display:inline-block;">
