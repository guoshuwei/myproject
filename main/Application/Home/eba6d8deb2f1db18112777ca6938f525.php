            ...
            <div class="page_cont">
                <div class="page_nav">
                    ...
                    <ul class="hd nav_ul">
                        <?php if(is_array($leftsublist)): foreach($leftsublist as $k=>$leftsublist): if(($k == $_GET['sid']) or ($leftsublist["index"] == 0)): ?><li class="sublist active">
                            ...
                            <?php else: ?>
                                  <!-- 判断是否是体检指南 -->
                                <?php if(($leftsublist['name'] == '体检指南')): ?><li  class="sublist"><a href="<?php echo U('index/'.$leftsublist[jump_url],'sid=97');?>"><?php echo ($leftsublist["name"]); ?> </a></li>
                                <?php else: ?>
                                    <li class="sublist" >
                                        <?php echo ($leftsublist["name"]); ?>
                ...
                <div class="bd page_introduce" style="font-size:12px;">
                    <?php if(is_array($re_leftsublist)): foreach($re_leftsublist as $key=>$re_leftsublist): if($re_leftsublist["index"] == 0): ?><ul class="item active">
                            <!-- 判断显示一条 -->
                                <?php if(count($re_leftsublist['sub']['title']) == 1): if(is_array($re_leftsublist["sub"]["content"])): foreach($re_leftsublist["sub"]["content"] as $k=>$content): ?><li>
