...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo U('YW/zhaoshang');?>" data-title="招商" href="javascript:void(0)">招商</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('PP/brand');?>" data-title="品牌管理" href="javascript:void(0)">品牌管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
