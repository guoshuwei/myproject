...
<div class="pd-20">
    <form action="<?php echo U('MV/product_edit');?>" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <?php  $uprootdir = '/tp32/Uploads/'.$editlist['picture_updata']; $complete_images = json_decode($editlist['picture_uplist'] , true); ?>
...
<!-- 引入剪裁js插件 -->
<script type="text/javascript" src="/tp32/Public/Admin/lib/cut/excanvas.js"></script>
<script type="text/javascript" src="/tp32/Public/Admin/lib/cut/zxx.crop_rotation.js"></script>
<!-- 图片拖拽排序 -->
<script type="" src="/tp32/Public/Admin/lib/cut/datouwang.js"></script>
