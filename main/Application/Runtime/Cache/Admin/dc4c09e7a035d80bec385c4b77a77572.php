...
<div class="pd-20">
  <form class="form form-horizontal" id="form-user-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="comments" id="comments" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,100)"><?php echo ($zjinfo[0]['description']); ?></textarea>
    ...
    <div class="row cl">
      <div class="col-9 col-offset-2">
        <?php if((isset($zjinfo[0]['id']) AND ($zjinfo[0]['id'] > 0))): ?><input class="btn btn-primary radius" onClick="item_edit(<?php echo ($zjinfo[0]['id']); ?>)" type="button" value="&nbsp;&nbsp;修改&nbsp;&nbsp;">
        <?php else: ?>
            <input class="btn btn-primary radius" onClick="item_add(0)" type="button" value="&nbsp;&nbsp;添加&nbsp;&nbsp;"><?php endif; ?>
      </div>
    </div>
  </form>
</div>
