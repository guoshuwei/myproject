...
<body>
<div class="pd-20">
	<form action="<?php echo U('SPGL/sub_add');?>" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
    ...
    <div class="row cl">
        <label class="form-label col-2">父级分类：</label>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" class="input-text" value="" id="jump_url" name="jump_url">
        </div>
    </div>
    <div class="row cl">
