...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 业务模块 <span class="c-gray en">&gt;</span> 招商 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	<div class="cl pd-5 bg-1 bk-gray"> <span class="l"><a class="btn btn-primary radius" href="javascript:;" onclick="admin_role_add('添加商户招商模板','<?php echo U('zhaoshang_add');?>','800')"><i class="Hui-iconfont">&#xe600;</i> 添加商户信息</a> </span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
