...
<body>
<div class="pd-20">
	<form action="<?php echo U('AD/admin_menu_add');?>" method="post" class="form form-horizontal" id="form-user-character-add">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>菜单父级：</label>
			<div class="formControls col-2"> 
	            <span class="select-box">
	                <select name="pname" class="select">
	                <option value="0">顶级分类</option>
	                <?php if(is_array($menulist)): foreach($menulist as $key=>$menulist): ?><option value="<?php echo @$menulist['id'];?>"><?php echo ($menulist["menu_name"]); ?>
	                    </option>
	                    <?php if($menulist['subname']): if(is_array($menulist["subname"])): foreach($menulist["subname"] as $key=>$subname): ?><option value="<?php echo ($key); ?>">&nbsp;&nbsp;├<?php echo ($subname); ?></option><?php endforeach; endif; endif; endforeach; endif; ?>   
	                </select>
	            </span> 
            </div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>菜单controller名称：</label>
			<div class="formControls col-4">
				<input type="text" class="input-text" id="controller" name="controller">
			</div>
			<label class="form-label col-2"><span class="c-red">*</span>菜单action名称：</label>
			<div class="formControls col-4">
