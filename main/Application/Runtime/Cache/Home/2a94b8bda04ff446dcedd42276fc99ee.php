									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<ul class="ul-round clearfix">
          									<?php if(is_array($toutiaolist)): foreach($toutiaolist as $k=>$list): ?><li><a href="<?php echo ($list['href']); ?>"><?php echo ($list['text']); ?></a></li><?php endforeach; endif; ?>  
									        </ul>
										</div>
									</div>
								</div>
								...
								<div class="owl-item deals_item">
									<div class="deals_info_line d-flex flex-row justify-content-start">
								        ...
								        <ul class="ul-round clearfix" style="padding: 12px 15px;">
								            <?php if(is_array($hygclist)): foreach($hygclist as $k=>$list): ?><li><a href="<?php echo ($list['href']); ?>"><?php echo ($list['text']); ?></a></li><?php endforeach; endif; ?>
								        </ul>
								      </div>
									</div>
								</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon">
							<a href="<?php echo U('zhaoshang/list');?>" target="_blank" class="ef360_ad" data-adcode="banner-240-60-1000_4"><img src="http://www.ef360.com/_Public/_UpFile/dins_240_60.gif" width="240" height="60"></a>
						</div>
