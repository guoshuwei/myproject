...
<head>
	<meta charset="UTF-8" />
    <title>农联网</title>
    <!-- <link href="/main/Public/Home/css/H-ui.admin.css" rel="stylesheet" type="text/css" /> -->
    <!-- 引入字体 font -->
    <!-- 引入网站图标 -->
    <link rel="shortcut icon" href="/main/Public/Home/images/favicon.ico" type="image/x-icon" />
    <link href="/main/Public/Home/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
    <link href="/main/Public/Home/css/style.css" rel="stylesheet" type="text/css" />
    <link href="/main/Public/Home/css/index.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/main/Public/Home/js/jquery-1.9.2.js"></script>
    <style>
...
<div class="index_body">
    	<div class="index_top">
            <div style="float: right;width: 350px;height: 100px;line-height: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;
                <?php if((isset($logining_user_name))): ?><span><?php echo ($logining_user_name); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
                <?php else: ?>
                    <a href="/user/login.php" target="blank">登录</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/user/register.php" target="blank">注册</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
                <a href="/cart/public/index.php" target="blank">交易平台</a>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="/main/index.php?s=/Admin/" target="blank">商户入口</a>
            </div>
            <!-- </div> -->
        	<!-- <img class="top_phone" src="/main/Public/Home/images/top_phone.png" /> -->
        	<!-- <img class="top_logo" src="/main/Public/Home/images/top_logo.png" /> -->
            <img class="top_img" src="/main/Public/Home/images/top_erweima.png" />
        </div>
        <div class="index_nav">
        	<ul style="padding-left:150px;">
            	<a style="display:inline-block;height:40px;line-height:40px;width:90px;text-align:center;float:left;color:#fff" href="./"><li class="has-line">首页</li></a>
                <?php if(is_array($navlist)): foreach($navlist as $key=>$navlist): ?><a href="<?php echo U('Index/'.$navlist['jump_url'],'id='.$navlist['id'] );?>" style="display:inline-block;height:40px;line-height:40px;width:90px;text-align:center;float:left;color:#fff">
                    <?php if(($key) == "7"): ?><li><?php echo ($navlist["name"]); ?></li>
                    <?php else: ?>
                        <li class="has-line"><?php echo ($navlist["name"]); ?></li><?php endif; ?>
...
<div id="demo01" class="flexslider">
            <ul class="slides">
            <?php if(is_array($bannerlist)): foreach($bannerlist as $key=>$bannerlist): ?><li><div class="img" style="background-color:#ddf"><a href=""><?php echo stripslashes(trim($bannerlist['src'],"\"")) ;?></a></div></li><?php endforeach; endif; ?>
            </ul>
        </div>
        <div class="index_guide">
        	<div class="guide_cont">
                ...
                <?php if(is_array($second_navitem)): foreach($second_navitem as $k=>$second_navitem): ?><li><a href="<?php echo U($second_navitem['jump_url']);?>">
                    	<img  src="/main/Public/Home/images/jiuyi_icon<?php echo ($k+1); ?>.png" />
                        <p><?php echo ($second_navitem["name"]); ?></p></a>
                    </li><?php endforeach; endif; ?>
                </ul>
                <div class="gu_inform" style="overflow:hidden;height:50px;line-height: 50px;">
                    <img style="position: absolute;top: 18px;left: 20px;" src="/main/Public/Home/images/tongzhi_icon.png">
                    ...
                    <div class="btnBox clearfix">
                        <img class="s-up" src="/main/Public/Home/images/s-up.png" alt="">
                        <img class="s-down" src="/main/Public/Home/images/s-down.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <?php if(is_array($fybjinfo)): foreach($fybjinfo as $k=>$fybj): if(($k%2 == 0)): if($k == 0): ?><li class="li1" style="margin-left:0px;"> <a href="<?php echo U('Index/mc_care','id='.$fybj['pid'].'&sid='.$fybj['id'] );?>">
                        <?php else: ?>
                         <li class="li1" > <a href="<?php echo U('Index/mc_care','id='.$fybj['pid'].'&sid='.$fybj['id'] );?>"><?php endif; ?> 
                                <img src="/main/Public/Home/images/baojian_img<?php echo ($k+1); ?>.png" />
                    ...
                    <?php else: ?>
                        <li class="li2"><a href="<?php echo U('Index/mc_care','id='.$fybj['pid'].'&sid='.$fybj['id'] );?>">
                            ...
                            <img class="heal_img2" src="/main/Public/Home/images/baojian_img<?php echo ($k+1); ?>.png" />
                ...
                <ul class="open_ul">
                	<li class="open_li" style="margin-left:0px;">
                    	<div class="open_img" style="height:100%;margin-top:0px;"><a href="<?php echo U('Index/ywpub', 'id='.$ywgk_p);?>">
                        	<img src="/main/Public/Home/images/yuanwu_icon1.png" style="    margin-top:40px;"/>
                            <p>院务公开</p></a>
                        </div>
                        <ul class="open_ul2">
                    ...
                    <li class="open_li">
                    	<div class="open_img" style="height:100%;margin-top:0px;"><a href="<?php echo U('Index/dwpub', 'id='.$ywgk_p.'&sid='.$dwgk_c);?>">
                        	<img src="/main/Public/Home/images/yuanwu_icon2.png" style="    margin-top:40px;"/>
                            <p>党务公开</p></a>
                        </div>
                        <ul class="open_ul2">
                    ...
                    <li class="open_li">
                        <div class="open_img" style="height:100%;margin-top:0px;"><a href="<?php echo U('Index/lzjs', 'id='.$ywgk_p.'&sid='.$lzjs_c);?>">
                            <img src="/main/Public/Home/images/yuanwu_icon3.png" style="margin-top:40px;"/>
                            <p>廉政建设</p></a>
                        </div>
                        <ul class="open_ul2">
...
<script type="text/javascript" src="/main/Public/Home/js/slider.js"></script>
<script type="text/javascript" src="/main/Public/Home/js/jquery.tab.min.js"></script>
<script type="text/javascript" src="/main/Public/Home/js/jquery.dataTables.js"></script>
