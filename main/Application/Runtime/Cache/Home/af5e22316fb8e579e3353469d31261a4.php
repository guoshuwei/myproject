...
<head>
    ...
    <!-- <link href="/tp32/Public/Home/css/H-ui.admin.css" rel="stylesheet" type="text/css" /> -->
    <!-- 引入字体 font -->
    <!-- 引入网站图标 -->
    <link rel="shortcut icon" href="/tp32/Public/Home/images/favicon.ico" type="image/x-icon" />
    <link href="/tp32/Public/Home/css/H-ui.admin.css" rel="stylesheet" type="text/css" />
    <link href="/tp32/Public/Home/css/style.css" rel="stylesheet" type="text/css" />
    <link href="/tp32/Public/Home/css/index.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" src="/tp32/Public/Home/js/jquery-1.9.2.js"></script>
    <style>
...
<div class="index_body">
    	<div class="index_top">
            <div style="float: right;width: 150px;height: 100px;line-height: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;
            <?php if((isset($logining_user_name))): ?><span><?php echo ($logining_user_name); ?></span>&nbsp;&nbsp;&nbsp;&nbsp;
            <?php else: ?>
                <a href="http://192.168.186.128:8080/otc_option/login.php" target="blank">登录</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://192.168.186.128:8080/otc_option/register.php" target="blank">注册</a>&nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
            <a href="http://192.168.186.128:8080/cart/public/index.php" target="blank">交易平台</a></div>
            <a href="http://192.168.186.128:8080/tp32/index.php?s=/Admin/" target="blank">商户入口</a></div>
        	<img class="top_phone" src="/tp32/Public/Home/images/top_phone.png" />
        	<img class="top_logo" src="/tp32/Public/Home/images/top_logo.png" />
            <img class="top_img" src="/tp32/Public/Home/images/top_erweima.png" />
        </div>
        <div class="index_nav">
        	<ul>
            	<a href="./"><li>首页</li></a>
...
<link href="/tp32/Public/Home/css/page.css" rel="stylesheet" type="text/css" />
    <div class="index_body">
        <div class="index_page">
            <div class="page_cont">
                <div class="page_nav">
                    <div class="nav_title">
                        <p class="title_p1">医院文化</p>
                ...
                <div class="bd page_introduce smt">
                    <?php if(is_array($re_leftsublist)): foreach($re_leftsublist as $k=>$re_leftsublist): if((isset($_GET['sid']) AND ($k == $_GET['sid']))): ?><ul class="item active">
                        ...
                        <?php else: ?>
                            <ul class="item">
                                <?php if(empty($re_leftsublist['sub']['content'])): ?><li style="text-align:center;margin-top:150px;">
                                            <?php echo '还没有上传数据。。。。';?>
                                    </li>  
                                <?php else: ?>
                                    <?php if(is_array($re_leftsublist["sub"]["content"])): foreach($re_leftsublist["sub"]["content"] as $k=>$content): ?><li>
...
<script type="text/javascript" src="/tp32/Public/Home/js/slider.js"></script>
<script type="text/javascript" src="/tp32/Public/Home/js/jquery.tab.min.js"></script>
<script type="text/javascript" src="/tp32/Public/Home/js/jquery.dataTables.js"></script>
