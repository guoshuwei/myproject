...
<div class="index_body">
    	<div class="index_top">
            <div style="float: right;width: 150px;height: 100px;line-height: 100px;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://192.168.186.128:8080/otc_option/login.php" target="blank">登录</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('User/register');?>">注册</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://192.168.186.128:8080/cart/public/index.php">交易平台</a></div>
...
<link href="/tp32/Public/Home/css/page.css" rel="stylesheet" type="text/css" />
	<div class="index_body">
        <div class="index_page">
        	<div class="page_cont m-tab J_Tab">
            	<div class="page_nav">
                	<div class="nav_title">
                    	<p class="title_p1">临床科室</p>
