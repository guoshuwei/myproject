				...
				<div class="p-basic clearfix">
					...
					<div class="box fl">
						...
						<ul class="p-list fl">
							...
							<li class="fl wb35">电话：{$user['mobile']}</li>
						</ul>
						<ul class="p-list fl">
					...
					<div class="bd">
						<div class="item">
							<ul class="p-list clearfix">
								<li class="fl wb25">企业名称：{$shenhe_info['name']}</li>
								<li class="fl wb25">电话：</li>
								<li class="fl wb25">企业简介：{$shenhe_info['description']}</li>
								<!-- <li class="fl wb25">直接上级：赵荣荣</li> -->
							</ul>
							<ul class="p-list clearfix">
								<li class="fl wb25">经营类型：养殖</li>
								<li class="fl wb25">营业执照：{$shenhe_info['business_license']}</li>
								<!-- <li class="fl wb25">email：liguokai@didichuxing.com</li> -->
							</ul>
							<ul class="p-list clearfix">
								<li class="fl wb25">地址：{$shenhe_info['address']}</li>
								<li class="fl wb25">授权公函：{$shenhe_info['authorization_letter']}</li>
