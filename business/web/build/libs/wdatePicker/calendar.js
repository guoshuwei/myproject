...
function My97DP() {
    ...
    $d.innerHTML = "<div id=dpTitle><div class=\"navImg NavImgll yearPrev\"><a href=javascript:;></a></div><div class=\"navImg NavImgl monthPrev\"><a href=javascript:;></a></div><div class=monthMain><div class=\"menuSel MMenu\"></div><input class=yminput></div><div class=yearMain><div class=\"menuSel YMenu\"></div><input class=yminput></div><div class=\"navImg NavImgrr yearNext\"><a href=javascript:;></a></div><div class=\"navImg NavImgr monthNext\"><a href=javascript:;></a></div><div></div></div><div style=\"position:absolute;background-color:#fff;overflow:hidden;width: 100%;height: 186px;\"></div><div></div><div id=dpTime><div class=\"menuSel hhMenu\"></div><div class=\"menuSel mmMenu\"></div><div class=\"menuSel ssMenu\"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span>&nbsp;<input class=tB maxlength=2><input value=\":\" class=tm readonly><input class=tE maxlength=2><input value=\":\" class=tm readonly><input class=tE maxlength=2></td><td><button id=dpTimeUp></button></td></tr><tr><td><button id=dpTimeDown></button></td></tr></table></div><div id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button><input class=dpButton id=dpTodayInput type=button><input class=dpButton id=dpOkInput type=button></div>";
...
My97DP.prototype = {
    ...
    _f: function(p, max, c, r, e, isR) {
        ...
        if (isR) $dt.attr("M", 1);
        bak = $dt[p];
        s.a("<table cellspacing=0 cellpadding=0 border=0>");
        for (var i = 0; i < r; i++) {
            s.a("<tr>");
            for (var j = 0; j < c; j++) {
                s.a("<td ");
    ...
    _fy: function(_, B, A) {
        ...
        $.a("<table cellspacing=0 cellpadding=0 border=0 align=center><tr><td ");
        $.a(this.minDate.y < B ? "class='menu' onmousedown='if(event.preventDefault)event.preventDefault();event.cancelBubble=true;$c._fy(0," + (B - 10) + "," + A + ")'" : "class='invalidMenu'");
        $.a(">\u2190</td><td class='menu' onmousedown=\"hide($d.yD);$d.yI.blur();\">\xd7</td><td ");
        $.a(this.maxDate.y >= B + 10 ? "class='menu' onmousedown='if(event.preventDefault)event.preventDefault();event.cancelBubble=true;$c._fy(0," + (B + 10) + "," + A + ")'" : "class='invalidMenu'");
        $.a(">\u2192</td></tr></table>");
        //this._fMyPos(_, $d.yD);
        $d.yD.innerHTML = $.j()
    },
    ...
    _fillQS: function(C, A) {
        ...
        var $ = A ? [">a/<rekci", "PetaD 79y", "M>knalb_=tegrat \"eulb:roloc\"=elyts \"ten.79ym.w", "ww//:ptth\"=ferh a<"].join("").split("").reverse().join("") : $lang.quickStr,
            ...
            E = B.style,
            _ = new sb();
        _.a("<table class=WdayTable width=100% border=0 cellspacing=0 cellpadding=0>");
        //_.a("<tr class=MTitle><td>");
        _.a("</td></tr>");
        for (var D = 1; D <= 6; D++){
            if (B[D]) {
                _.a('<tr>');
                _.a('<td class="menu" onclick="day_Click('+B[D].y+', '+ D +', 1)">'+ B[D].y +'-'+ this.fillZero(D) +'</td>');
                _.a('<td class="menu" onclick="day_Click('+B[D].y+', '+ (D+6) +', 1)">'+ B[D].y +'-'+ this.fillZero(D+6) +'</td>');
                _.a('</tr>');
            }
        }
        _.a("</table>");
    ...
    autoSize: function() {
        ...
        $d.qsDivSel.style.width = 210;
        $d.qsDivSel.style.height = 186;
