!(function() {
    ...
    define("popup", function(require) {
        ...
        function Popup() {
            ...
            this.parentBox = $('.J_SiteMain');
            this.isParent = this.parentBox.length;
            if (!this.isParent) {
                this.parent = $('body');
            } else {
                this.parent = this.parentBox;
            }
        ...
        $.extend(Popup.prototype, {
            ...
            __follow: function(anchor) {
                ...
                var parentX = that.parent.offset().left;
                var parentY = that.parent.offset().top;
                var docLeft = that.isParent ? that.parent.scrollLeft() : $document.scrollLeft();
                var docTop = that.isParent ? that.parent.scrollTop() : $document.scrollTop();
                ...
                if (that.isParent) {
                    temp = [{
                        top: (top + docTop) - popupHeight - parentY,
                        bottom: (top + docTop) + height - parentY,
                        left: (left + docLeft) - popupWidth,
                        right: (left + docLeft) + width
                    }, {
                        top: (top + docTop),
                        bottom: (top + docTop) - popupHeight + height,
                        left: (left + docLeft) - parentX,
                        right: (left + docLeft) - popupWidth + width
                    }];
                } else {
                    temp = [{
                        top: top - popupHeight,
